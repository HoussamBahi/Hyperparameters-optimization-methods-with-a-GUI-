...
from sklearn.model_selection import train_test_split, KFold, GridSearchCV, RepeatedKFold,HalvingGridSearchCV
...
if __name__ == "__main__":
    root = Tk()
    root.title('Halving Grid Search')
    ...
    mylist.grid(row=8, column=2, rowspan=4,
                columnspan=6)
    scrollbar.config(command=mylist.yview)
    button_1 = Button(root, text='Start Halving Grid Search', width='20', height='5', command=halv_grid)
    button_1.grid(row=12, column=8)
